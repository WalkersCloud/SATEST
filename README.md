[![the peggies](https://telegra.ph/file/7835a3c714c3b5e93cc35.jpg)](https://youtu.be/I1hLZ2OchZ8)

# Mizuhara Mirror

**Mizuhara mirror** is a _multipurpose_ Telegram Bot writen in Python for mirroring files on the Internet to our beloved Google Drive. forked from [slam-mirror bot](https://github.com/breakdowns/slam-mirrorbot).
...
- Clone this repo:
```
git clone https://github.com/walkerdcloud/Mizuhara-Mirror mirrorbot/
cd mirrorbot
```
...
- [Breakdowns](https://github.com/breakdowns) for managing this his awsome code
