...
class GoogleDriveHelper:
    ...
    def upload_file(self, file_path, file_name, mime_type, parent_id):
        ...
        file_metadata = {
            'name': file_name,
            'description': 'Uploaded by Uploader',
            'mimeType': mime_type,
        }
        try:
    ...
    def clone(self, link):
        ...
        try:
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'<b>📁 Filename: </b><code>{meta.get("name")}</code>\n<b>〽️Size: </b><code>{get_readable_file_size(self.transferred_size)}</code>'
    ...
    def edit_telegraph(self):
        ...
        for content in self.telegraph_content :
            ...
            Telegraph(access_token=telegraph_token).edit_page(path = self.path[prev_page],
                                 title = 'Mizuhara Mirror',
                                 author_name='Mizuhara',
    ...
    def count(self, link):
        ...
        try:
            ...
            if drive_file['mimeType'] == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'\n<b>〽️ Size: </b><code>{get_readable_file_size(self.total_bytes)}</code>'
                msg += f'\n<b>⚙️ Type: </b><code>Folder</code>'
                msg += f'\n<b>🗂️ SubFolders: </b><code>{self.total_folders}</code>'
                msg += f'\n<b>Files: </b><code>{self.total_files}</code>'
            else:
