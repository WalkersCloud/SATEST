...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg += f"\n\nExample:\n<code>/{BotCommands.WatchCommand} https://youtu.be/I1hLZ2OchZ8 720 |the peggies </code>\n\n"
        msg += "This file will be downloaded in 720p quality and it's name will be <b>the peggies</b>"
